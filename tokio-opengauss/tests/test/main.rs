...
use tokio_opengauss::tls::{NoTls, NoTlsStream};
use tokio_opengauss::types::{Kind, Type};
use tokio_opengauss::{
...
async fn query_typed_no_transaction() {
    ...
    let rows: Vec<tokio_opengauss::Row> = client
        .query_typed(
...
async fn query_typed_with_transaction() {
    ...
    let rows: Vec<tokio_opengauss::Row> = transaction
        .query_typed(
