...
//! # Implementation
//!
//! This crate is a lightweight wrapper over tokio-opengauss. The `opengauss::Client` is simply a wrapper around a
//! `tokio_opengauss::Client` along side a tokio `Runtime`. The client simply blocks on the futures provided by the async
//! client.
//!
//! # SSL/TLS support
//!
...
//! `opengauss-openssl` and `opengauss-native-tls` crates provide implementations backed by the `openssl` and `native-tls`
//! crates, respectively.
//!
//! # Features
//!
