...
//!
//! This crate is used by the `tokio-opengauss` and `opengauss` crates. You normally don't need to depend directly on it
...
//! ```toml
//! [dependencies]
//! opengauss-types = { version = "0.X.X", features = ["derive"] }
//! ```
//!
//! ## Enums
//!
...
#[cfg(feature = "derive")]
pub use opengauss_derive::{FromSql, ToSql};
